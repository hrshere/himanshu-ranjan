        ...
        <div className="flex flex-wrap lg:flex-row-reverse">
            <div className="w-full lg:w-1/2">
                <div className="flex justify-center lg:p-8">
                    <motion.img src={profilePic} alt="Himanshu Ranjan"  className="border border-stone-900 rounded-3xl" initial={{x: 100, opacity: 0}} animate={{x:0,opacity:1}} transition={{duration:1,delay:1.5}}/>
                </div>
            </div>
            <div className="w-full lg:w-1/2">
            <motion.div
            ...
            className="flex flex-col items-center lg:items-start m-10">
                ...
                variants={childVariants}
                 className="pb-2 text-4xl tracking-lighter lg:text=8xl">Himanshu Ranjan Singh
                 </motion.h2>
                <motion.span
                variants={childVariants}
